        ...
        <Fragment>
            <nav className="navbar navbar-dark bg-dark">
                <div className="container-fluid">
                    <a className="navbar-brand"><h2>Burger</h2></a>
                    ...
                    <ul className="nav col-12 col-lg-auto my-2 justify-content-center my-md-0 text-small d-flex">
                        ...
                        <li>
                            ...
                            <button type="button" className="btn btn-dark" data-bs-toggle="modal" data-bs-target="#ModalBurger">
            ...
            <div className="modal fade" id="ModalBurger" tabIndex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
                <div className="modal-dialog">
                    <div className="modal-content">
                        ...
                        <div className="container text-center modal-body">
                            <Carrito 
                              carrito={carrito}
                              setCarrito={setCarrito}
